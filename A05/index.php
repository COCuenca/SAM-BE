...
<div class="w3-padding-large" id="main">
    ...
    <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
        ...
        <p>This website showcases your core memories in a beautiful and interactive way. Navigate through your islands of personality to relive precious moments.</p>
    </div>
    ...
    <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
        ...
        <div class="w3-section">
            <p><i class="fa fa-map-marker fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Maila, Philippines</p>
            <p><i class="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Phone:  09300324397</p>
            <p><i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Email: cuencachristianodchimar1220@gmail@mail.com</p>
        </div>
